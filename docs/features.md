...
| Forge | ✅ | 1.20.1, 1.20.4, 1.21.1 |
| Fabric | ✅ | 1.20.1, 1.20.4, 1.21.1 |
...
| `/mapsyncer clearstate` | ✅ | 清除同步恢复状态（隐藏命令） |
...
| Payload | 方向 | 说明 |
|---------|------|------|
| `ServerInstalledPayload` | 服务端→客户端 | 玩家加入时通知服务端已安装 MapSyncer |
