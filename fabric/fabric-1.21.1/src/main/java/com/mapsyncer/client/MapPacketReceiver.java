 ...
 * </ul>
 *
 * <p>注意：此类通过 NetworkManager.getHandler().registerHandlers() 注册处理器，
 * 在模组初始化时调用 register() 方法。</p>
 */
// Note: This class registers handlers via NetworkManager.getHandler().registerHandlers()
// Call register() method during mod initialization.
public class MapPacketReceiver {
    ...
    public static void register() {
        ...
        // 注册进度更新处理器
        handler.registerSyncProgressHandler(MapPacketReceiver::handleProgressUpdate);
