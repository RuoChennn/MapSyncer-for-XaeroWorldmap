 ...
 *
 * <p>注意：MC 26.1 采用新的“提取渲染状态”模型（{@link GuiGraphicsExtractor}），
 * 旧的 {@code render(GuiGraphics, ...)} 已移除，因此本类重写
 * {@code extractBackground} 以绘制标题与状态文字，与其他版本不共享源码。</p>
 */
public class PreDisconnectSyncScreen extends Screen {
    ...
    public void extractBackground(GuiGraphicsExtractor extractor, int mouseX, int mouseY, float partialTick) {
        ...
        // 状态文字。
        extractor.centeredText(this.font, statusComponent, this.width / 2, this.height / 2 + STATUS_Y_OFFSET, 0xCCCCCC);
    }
