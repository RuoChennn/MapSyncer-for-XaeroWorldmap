...
本文档详细列出了 MapSyncer for XaeroWorldmap 模组已实现的全部功能。

---

## 一、核心功能概述

MapSyncer 是一个 Minecraft NeoForge 1.21.1 模组，核心功能是将服务端已探索的区域地图数据同步到客户端的 Xaero's World Map。模组完全由 AI 编写，实现了从 MCA 文件解析、Xaero 格式转换、网络同步到客户端地图刷新的完整流程。
...
#### Chunk Update 控制
- 同步开始时暂停 Xaero 的区块更新处理
- 防止同步过程中 Xaero 写入数据冲突
- 同步完成后恢复区块更新
...
**文档版本**: 1.1
**最后更新**: 2026-05-18
**模组版本**: MapSyncer for XaeroWorldmap NeoForge 1.21.1
